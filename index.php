...
<div id="content_wrap" class="content-wrap">
  ...
  <ol class="level-2-wrapper">
    ...
    <li>
      ...
      <ol class="level-3-wrapper">
        <li>
          <p class="level-3 rectangle" style="margin:0px !important;font-weight:bold;">Manager C</p>
          <ol class="level-4-wrapper">
            <li>
              <h4 class="level-4 rectangle">Person A</h4>
            </li>
        ...
        <li>
          <p class="level-3 rectangle" style="margin:0px !important;font-weight:bold;">Manager D</p>
          <ol class="level-4-wrapper">
            <li>
              <h4 class="level-4 rectangle">Person A</h4>
            </li>
